...
<div class="space-y-6">
    ...
    <form class="space-y-4">
        <x-ui.auth-field name="email" label="Official email" type="email" value="admin@startupindia.gov.in" autocomplete="email" />
        <x-ui.auth-field name="password" label="New password" type="password" autocomplete="new-password" toggle="true" error="Passwords must be strong enough for protected registry data." />
